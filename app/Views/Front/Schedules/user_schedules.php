    ...
    <script>
        ...
        const getUserSchedules = async () => {
            ...
            if (!response.ok) {
                ...
                boxErrors.innerHTML = showErrorMessage('Não foi possivel recuperar os agendamentos');
        ...
        const tryCancelUserSchedule = async (schedule) => {
            ...
            if (!response.ok) {
                ...
                boxErrors.innerHTML = showErrorMessage('Não foi possivel cancelar os agendamentos');
