<div class="row">
    ...
    <div class="form-group col-md-4">
        ...
        <input type="time" class="form-control" name="starttime" value="<?php echo old('starttime', $unit->starttime); ?>" id="starttime" aria-describedby="startimeHelp" placeholder="Inicio expediente">  
        <?php echo show_error_input('starttime'); ?>
    </div>

    <div class="form-group col-md-4">
        <label for="endtime">Fim expediente</label>
        <input type="time" class="form-control" name="endtime" value="<?php echo old('endtime', $unit->endtime); ?>" id="endtime" aria-describedby="endtimeHelp" placeholder="Fim expediente">  
...
<a href="<?php echo route_to('units') ?>" class="btn btn-secondary">Voltar</a>