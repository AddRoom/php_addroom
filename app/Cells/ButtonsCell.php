...
{
    /**
     * Renderiza um button com formulario HTML para ativaçõo ou desativação do registro
     * 
     * @param array $params [
    ...
    /**
     * Renderiza um button com formulario HTML para exclusão do registro
     * 
     * @param array $params [
    ...
    public function destroy(array $params): string
    {
        ...
        $form .= form_button([
            'class'   => $params['btn_class'] ?? ' btn btn-ms btn-danger',
            'type'    => 'submit',
